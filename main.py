...
run_ani_R = [pygame.image.load("joueur1 (1).png"), pygame.image.load(
    "joueur1 (2).png"), pygame.image.load("joueur1 (3).png"), pygame.image.load("joueur1 (4).png"), ]
run_ani_L = [pygame.image.load("joueur1gauche (1).png"), pygame.image.load(
    "joueur1gauche (2).png"), pygame.image.load("joueur1gauche (3).png"), pygame.image.load("joueur1gauche (4).png"), ]


class Background(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.bgimage = pygame.image.load("bg2.png").convert()
        self.bgY = 0
        self.bx = 0 

    def render(self):
        displaysurface.blit(self.bgimage, (self.bx, self.bgY))
